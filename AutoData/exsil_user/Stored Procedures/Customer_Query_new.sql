...
CREATE    PROCEDURE exsil_user.Customer_Query_new
	(
...
SELECT   @MainID = LEFT(LM.Lot, 4)
	, @SPEC_NUMBER = Spec.SPEC_NUMBER, @SPEC_REV_NUMBER = Spec.SPEC_REV_NUMBER
	, @PART_NUMBER = Spec.PART_NUMBER, @PART_REV_NUMBER = Spec.PART_REV_NUMBER
	, @ORTN = Spec.ORTN
