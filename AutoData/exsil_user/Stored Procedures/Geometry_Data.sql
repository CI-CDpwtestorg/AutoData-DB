...
CREATE   PROCEDURE exsil_user.Geometry_Data
	(
...
*/	
	...
	FROM dbo.ADE_data INNER JOIN
			...
			--AND SUBSTRING(A.Lot, 1, 4) = ADE_data.[ID#]
				INNER JOIN
                dbo.Sorter_Info ON @Mainid = Sorter_Info.[ID] AND ADE_data.location = Sorter_Info.Tool AND ADE_data.class = Sorter_Info.Class
