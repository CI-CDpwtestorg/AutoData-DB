...
CREATE     PROCEDURE exsil_user.SP1DataCollector_2009_07_18
AS
INSERT      SP1_Data
...
FROM         OPENDATASOURCE('SQLOLEDB','Data Source=ex-az-211; User ID=sa; Password=').sp1.dbo.TBL_DataSumClassification Class INNER JOIN
             OPENDATASOURCE('SQLOLEDB','Data Source=ex-az-211; User ID=sa; Password=').sp1.dbo.TBL_DataSumInfo Info ON Class.CreationDate = Info.CreationDate INNER JOIN
             OPENDATASOURCE('SQLOLEDB','Data Source=ex-az-211; User ID=sa; Password=').sp1.dbo.TBL_DataSumCommonChannel Chnl ON Chnl.ChannelID = Class.ChannelID AND Info.CreationDate = Chnl.CreationDate INNER JOIN
             OPENDATASOURCE('SQLOLEDB','Data Source=ex-az-211; User ID=sa; Password=').sp1.dbo.TBL_DataSumHazeMap Haze ON Class.ChannelID = Haze.ChannelID AND Info.CreationDate = Haze.CreationDate INNER JOIN
             OPENDATASOURCE('SQLOLEDB','Data Source=ex-az-211; User ID=sa; Password=').sp1.dbo.TBL_DataSumDefect Defect ON Haze.ChannelID = Defect.ChannelID AND Info.CreationDate = Defect.CreationDate LEFT OUTER JOIN
