...
CREATE     PROCEDURE [exsil_user].[SP1DataCollector_All]
AS
INSERT      SP1_Data
...
FROM         SP11.SP1.dbo.TBL_DataSumClassification Class INNER JOIN
             SP11.SP1.dbo.TBL_DataSumInfo Info ON Class.CreationDate = Info.CreationDate INNER JOIN
             SP11.sp1.dbo.TBL_DataSumCommonChannel Chnl ON Chnl.ChannelID = Class.ChannelID AND Info.CreationDate = Chnl.CreationDate INNER JOIN
             SP11.sp1.dbo.TBL_DataSumHazeMap Haze ON Class.ChannelID = Haze.ChannelID AND Info.CreationDate = Haze.CreationDate INNER JOIN
             SP11.sp1.dbo.TBL_DataSumDefect Defect ON Haze.ChannelID = Defect.ChannelID AND Info.CreationDate = Defect.CreationDate LEFT OUTER JOIN
             dbo.SP1_Data SP1 ON Info.CreationDate = SP1.CreationDate AND SP1.Machine='SP1'
WHERE     (SP1.CreationDate IS NULL) 
	AND (LEFT(Defect.ChannelID, 9) = 'Composite')	
ORDER BY Info.CreationDate	

--Insert new SP1 Data as SP2
INSERT      SP1_Data
	(Machine, CreationDate, SPSessionName, SPRecipeName, SessionDate
	, [ID#],[RUN#], Wafer_log
	, Comment1, Comment2, ChannelID, SourceSlotID, 
              ...
              LPDNBinCntInSize8, LPDNBinCntInSize18, Average, Peak, Median, StdDeviation, Thruput, WaferDia, EdgeExclusion, DestinationStationID, 
              DestinationSlotID, WaferIdLabel, Comment, SOD1, SOD2, SOD3, SOD4, SOD5, SOD6, SOD7, SOD8, SOD18)
SELECT    'SP2', Info.CreationDate, Info.SPSessionName, Info.SPRecipeName, Info.SessionDate
	, ltrim(rtrim(Info.LotIdLabel)), ltrim(rtrim( Info.StepID)), ltrim(rtrim(Info.ProcessToolID)), 
              Info.ProcessGroup, Info.ProcessArea, Defect.ChannelID, Info.SourceSlotID, Info.DispositionName, Chnl.SumAllDefects, Info.FailedLimit, 
              Class.AreaCnt, Class.TotalArea, Class.ScratchCnt, Class.ScratchTotalLength, Class.ScratchMaxLength, Class.ScratchAveLength, Class.ClusterAreaCnt, 
              Class.LPDECnt, Class.LPDSCnt, Defect.PosCnt, Defect.NegCnt, Defect.WaferPosAvgDensity, Defect.WaferPosMean, Defect.WaferPosStdDev, 
              ...
              Defect.BinCnt7 + Defect.LPDNBinCntInSize7 AS SOD7, Defect.BinCnt8 + Defect.LPDNBinCntInSize8 AS SOD8, 
              Defect.BinCnt18 + Defect.LPDNBinCntInSize18 AS SOD18
FROM         dbo.TBL2_DataSumClassification Class INNER JOIN
                      dbo.TBL2_DataSumInfo Info ON Class.CreationDate = Info.CreationDate INNER JOIN
                      dbo.TBL2_DataSumCommonChannel Chnl ON Chnl.ChannelID = Class.ChannelID AND Info.CreationDate = Chnl.CreationDate INNER JOIN
                      dbo.TBL2_DataSumHazeMap Haze ON Class.ChannelID = Haze.ChannelID AND Info.CreationDate = Haze.CreationDate INNER JOIN
                      dbo.TBL2_DataSumDefect Defect ON Haze.ChannelID = Defect.ChannelID AND Info.CreationDate = Defect.CreationDate LEFT OUTER JOIN
                      dbo.SP1_Data SP1 ON Info.CreationDate = SP1.CreationDate AND SP1.Machine='SP2'
WHERE     (SP1.CreationDate IS NULL) 
	AND (LEFT(Defect.ChannelID, 9) = 'Composite')
ORDER BY Info.CreationDate	


--Insert new SP1 Data as SP1_3
INSERT      SP1_Data
	(Machine, CreationDate, SPSessionName, SPRecipeName, SessionDate
	, [ID#],[RUN#], Wafer_log
	, Comment1, Comment2, ChannelID, SourceSlotID, 
              ...
              LPDNBinCntInSize8, LPDNBinCntInSize18, Average, Peak, Median, StdDeviation, Thruput, WaferDia, EdgeExclusion, DestinationStationID, 
              DestinationSlotID, WaferIdLabel, Comment, SOD1, SOD2, SOD3, SOD4, SOD5, SOD6, SOD7, SOD8, SOD18)
SELECT    'SP1-3', Info.CreationDate, Info.SPSessionName, Info.SPRecipeName, Info.SessionDate
	, ltrim(rtrim(Info.LotIdLabel)), ltrim(rtrim( Info.StepID)), ltrim(rtrim(Info.ProcessToolID)), 
              Info.ProcessGroup, Info.ProcessArea, Defect.ChannelID, Info.SourceSlotID, Info.DispositionName, Chnl.SumAllDefects, Info.FailedLimit, 
              Class.AreaCnt, Class.TotalArea, Class.ScratchCnt, Class.ScratchTotalLength, Class.ScratchMaxLength, Class.ScratchAveLength, Class.ClusterAreaCnt, 
              Class.LPDECnt, Class.LPDSCnt, Defect.PosCnt, Defect.NegCnt, Defect.WaferPosAvgDensity, Defect.WaferPosMean, Defect.WaferPosStdDev, 
              ...
              Defect.BinCnt7 + Defect.LPDNBinCntInSize7 AS SOD7, Defect.BinCnt8 + Defect.LPDNBinCntInSize8 AS SOD8, 
              Defect.BinCnt18 + Defect.LPDNBinCntInSize18 AS SOD18
FROM         SP1_3.SP1.dbo.TBL_DataSumClassification Class INNER JOIN
             SP1_3.SP1.dbo.TBL_DataSumInfo Info ON Class.CreationDate = Info.CreationDate INNER JOIN
             SP1_3.sp1.dbo.TBL_DataSumCommonChannel Chnl ON Chnl.ChannelID = Class.ChannelID AND Info.CreationDate = Chnl.CreationDate INNER JOIN
             SP1_3.sp1.dbo.TBL_DataSumHazeMap Haze ON Class.ChannelID = Haze.ChannelID AND Info.CreationDate = Haze.CreationDate INNER JOIN
             SP1_3.sp1.dbo.TBL_DataSumDefect Defect ON Haze.ChannelID = Defect.ChannelID AND Info.CreationDate = Defect.CreationDate LEFT OUTER JOIN
             dbo.SP1_Data SP1 ON Info.CreationDate = SP1.CreationDate AND SP1.Machine='SP1-3'
WHERE     (SP1.CreationDate IS NULL) 
	AND (LEFT(Defect.ChannelID, 9) = 'Composite')	
ORDER BY Info.CreationDate	
