...
CREATE      PROCEDURE exsil_user.SP3DataCollector
AS
INSERT      SP1_Data
...
FROM         	OPENDATASOURCE ('SQLOLEDB','Data Source=SP2-S0132; User ID=data; Password=Network_1').KTResults_520.dbo.TBL_ResultsCharData TBL_ResultsCharData INNER JOIN
                      OPENDATASOURCE('SQLOLEDB','Data Source=SP2-S0132; User ID=data; Password=Network_1').KTResults_520.dbo.TBL_ResultsSumBinData TBL_ResultsSumBinData_1 ON 
                      TBL_ResultsCharData.CreationDate = TBL_ResultsSumBinData_1.CreationDate LEFT OUTER JOIN
                      OPENDATASOURCE('SQLOLEDB','Data Source=SP2-S0132; User ID=data; Password=Network_1').KTResults_520.dbo.TBL_ResultsSumBinData TBL_ResultsSumBinData_2 ON 
                      TBL_ResultsCharData.CreationDate = TBL_ResultsSumBinData_2.CreationDate LEFT OUTER JOIN
                      OPENDATASOURCE('SQLOLEDB','Data Source=SP2-S0132; User ID=data; Password=Network_1').KTResults_520.dbo.TBL_ResultsLongData TBL_ResultsLongData_2 ON 
                      TBL_ResultsCharData.CreationDate = TBL_ResultsLongData_2.CreationDate LEFT OUTER JOIN
                      OPENDATASOURCE('SQLOLEDB','Data Source=SP2-S0132; User ID=data; Password=Network_1').KTResults_520.dbo.TBL_ResultsLongData TBL_ResultsLongData_1 ON 
                      TBL_ResultsCharData.CreationDate = TBL_ResultsLongData_1.CreationDate LEFT OUTER JOIN

		      OPENDATASOURCE('SQLOLEDB','Data Source=SP2-S0132; User ID=data; Password=Network_1').KTResults_520.dbo.TBL_ResultsLongData TBL_ResultsLongData_3 ON 
                      TBL_ResultsCharData.CreationDate = TBL_ResultsLongData_3.CreationDate LEFT OUTER JOIN

                      OPENDATASOURCE('SQLOLEDB','Data Source=SP2-S0132; User ID=data; Password=Network_1').KTResults_520.dbo.TBL_ResultsCharData TBL_ResultsCharData_7 ON 
                      TBL_ResultsCharData.CreationDate = TBL_ResultsCharData_7.CreationDate LEFT OUTER JOIN
                      OPENDATASOURCE('SQLOLEDB','Data Source=SP2-S0132; User ID=data; Password=Network_1').KTResults_520.dbo.TBL_ResultsCharData TBL_ResultsCharData_6 ON 
                      TBL_ResultsCharData.CreationDate = TBL_ResultsCharData_6.CreationDate LEFT OUTER JOIN
                      OPENDATASOURCE('SQLOLEDB','Data Source=SP2-S0132; User ID=data; Password=Network_1').KTResults_520.dbo.TBL_ResultsCharData TBL_ResultsCharData_5 ON 
                      TBL_ResultsCharData.CreationDate = TBL_ResultsCharData_5.CreationDate LEFT OUTER JOIN
                      OPENDATASOURCE('SQLOLEDB','Data Source=SP2-S0132; User ID=data; Password=Network_1').KTResults_520.dbo.TBL_ResultsCharData TBL_ResultsCharData_4 ON 
                      TBL_ResultsCharData.CreationDate = TBL_ResultsCharData_4.CreationDate LEFT OUTER JOIN
                      OPENDATASOURCE('SQLOLEDB','Data Source=SP2-S0132; User ID=data; Password=Network_1').KTResults_520.dbo.TBL_ResultsCharData TBL_ResultsCharData_3 ON 
                      TBL_ResultsCharData.CreationDate = TBL_ResultsCharData_3.CreationDate LEFT OUTER JOIN
                      OPENDATASOURCE('SQLOLEDB','Data Source=SP2-S0132; User ID=data; Password=Network_1').KTResults_520.dbo.TBL_ResultsCharData TBL_ResultsCharData_2 ON 
                      TBL_ResultsCharData.CreationDate = TBL_ResultsCharData_2.CreationDate LEFT OUTER JOIN
                      OPENDATASOURCE('SQLOLEDB','Data Source=SP2-S0132; User ID=data; Password=Network_1').KTResults_520.dbo.TBL_ResultsCharData TBL_ResultsCharData_1 ON 
